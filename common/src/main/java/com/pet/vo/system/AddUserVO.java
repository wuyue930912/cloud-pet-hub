...
public class AddUserVO {
    ...
    @ApiModelProperty(value = "用户名", required = true, dataType = "String", position = 1, example = "xxp")
    ...
    @ApiModelProperty(value = "密码", required = true, dataType = "String", position = 2, example = "wuyue930912")
    private String userPwd;

    @Length(min = 11, max = 11, message = ErrorMsgConstant.PHONE_ERROR)
    @ApiModelProperty(value = "手机号", dataType = "String", position = 3, example = "18410261912")
    private String userPhone;

    @Length(max = 64, message = ErrorMsgConstant.EMAIL_TOO_LONG)
    @ApiModelProperty(value = "邮箱", dataType = "String", position = 4, example = "wuyue930912@live.com")
